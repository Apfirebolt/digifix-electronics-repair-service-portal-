...
class Complaint(models.Model):
  ...
  assigned_engineer = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, limit_choices_to= Q( groups__name = 'Engineers'), related_name='assignments', null=True, blank=True)
...
class ReportIssue(models.Model):
  ...
  written_by = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='all_user_issues', null=True, blank=True)
...
class Comments(models.Model):
  ...
  written_by = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='all_comments', null=True, blank=True)
